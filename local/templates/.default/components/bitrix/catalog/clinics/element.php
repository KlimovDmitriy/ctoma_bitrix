...
global $clinicFilter;
$clinicFilter = ['PROPERTY_WORK_PLACE' => $ElementID];
/*Фильтрация врачей по месту работы (текущей клинике)*/
$Vraci=$APPLICATION->IncludeComponent(
    "bitrix:news.list",
    "doctors_slider",
    array(
...
<?
/*Фильтрация отзывов врачей по месту работы (текущей клинике)*/
global $clinicRFilter;
$clinicRFilter = ['PROPERTY_DOCTOR' => $Vraci];
/*Фильтрация отзывов врачей по месту работы (текущей клинике)*/
