...
<div class="iblock-vote" id="vote_<?echo $arResult["ID"]?>">
    ...
    //результатом запроса
    ?>
    <table border="0" cellspacing="0" cellpadding="0" class="ratingArt">
        <tr>
        ...
        <table border="0" cellspacing="0" cellpadding="0" class="ratingArt">
            <tr>
                <?if($arResult["PROPERTIES"]["vote_count"]["VALUE"]):?>
                    <td class="vote-result"><div id="wait_vote_<?echo $arResult["ID"]?>"><?echo GetMessage("T_IBLOCK_VOTE_RESULTS", array("#RATING#"=>$DISPLAY_VALUE, "#VOTES#"=>$arResult["PROPERTIES"]["vote_count"]["VALUE"]))?></div></td>
                <?else:?>
