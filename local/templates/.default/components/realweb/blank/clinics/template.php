...
<div id="choosingClinic" xmlns:v-on="http://www.w3.org/1999/xhtml" class="choosingClinic">
    ...
    <span class="choosingClinic__list">
        ...
        <div class="choosingClinic__clinic" data-id="<?=$clinic['ID']?>" data-url="/clinics/<?=$clinic['CODE']?>/">


            <a href="/clinics/<?=$clinic['CODE']?>/"><span class="choosingClinic__listName"><?=$clinic['NAME']?></span>
