...
class d2mg_ufhtml extends CModule
{
	...
	function DoInstall()
	{
		...
		$this->InstallDB();
		$APPLICATION->IncludeAdminFile(GetMessage("inst_inst_title"), $DOCUMENT_ROOT."/local/modules/d2mg.ufhtml/install/step.php");
	}
	...
	function DoUninstall()
	{
		global $DOCUMENT_ROOT, $APPLICATION;
		$this->UnInstallDB();
		$APPLICATION->IncludeAdminFile(GetMessage("inst_uninst_title"), $DOCUMENT_ROOT."/local/modules/d2mg.ufhtml/install/unstep.php");
	}
