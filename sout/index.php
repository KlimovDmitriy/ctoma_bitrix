...
$APPLICATION->SetPageProperty("title", "Сводные данные о результатах проведения СОУТ | Группа компаний «СТОМА»");
$APPLICATION->SetPageProperty("keywords", "");
$APPLICATION->SetPageProperty("description", "Сводные данные о результатах проведения СОУТ |");
?>
...
<? $APPLICATION->IncludeComponent(
    ...
    array(
        ...
        "IBLOCK_ID" => \Realweb\Site\Site::getIblockId('sout'),
        "IBLOCK_TYPE" => "content",
