...
$APPLICATION->SetPageProperty("title", "Статьи | Группа компаний «СТОМА»");
$APPLICATION->SetPageProperty("keywords", "");
$APPLICATION->SetPageProperty("description", "Полезные статьи и материалы о стоматологии от специалистов клиники «СТОМА»");
?><? $APPLICATION->IncludeComponent(
    ...
    Array(
        ...
        "SEF_FOLDER" => "/articles/",
        "SEF_MODE" => "Y",
        "SEF_URL_TEMPLATES" => array("compare" => "", "element" => "#ELEMENT_CODE#/", "section" => "", "sections" => "/articles/", "smart_filter" => ""),
        "SET_LAST_MODIFIED" => "N",
        "SET_STATUS_404" => "N",
        "SET_TITLE" => "Y",
        "SHOW_404" => "N",
